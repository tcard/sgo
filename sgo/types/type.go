...
// An Optional represents an optional type.
type Optional struct {
	elem Type
}

// NewOptional returns a new optional type for the given element (base) type.
func NewOptional(elem Type) *Optional { return &Optional{elem: elem} }

// Elem returns the element type for the given optional o.
...
// NewTupleEntangled returns a new tuple for the given variables. The last
...
// Params returns the results of signature s, or nil.
